...
For this assignment, you will collaborate in your (randomly assigned) groups (see Blackboard), but you will each submit your own assignment.
You may share code with your group via Blackboard Group Messages (general FYI - instructors can see these messages!).
...
In the YAML, this assignment is currently set to have `theme: "cosmo"`. See a list of all available themes below and on the [Quarto website](https://quarto.org/docs/output-formats/html-themes.html).
...
Unfortunately Blackboard does not like .html files, so you'll need to export / "print" your html file as a pdf. You will submit a pdf file to the R HW 01 assignment on Blackboard. 
