...
7. Using the 2023 data, produce graphs of happiness as the dependent (y) variable and each other variable from Exercise 6 as the independent (x) variables (one at a time; 4 total visualizations). For scatterplots, include a smoothed curve (geom_smooth) as well. 
