...
1.  Add "STAT 5700" as a subtitle. Hint `subtitle:` goes right below `title:` at the top of the document.
...
Once you have completed Tasks 1 - 6, render the document one last time. Look over the .html document to make sure that everything is visible and formatted as you intended. To submit this lab assignment, you will upload your Lab_01.html file to Blackboard under the Lab 01 assignment. This file exists in the MATH_361 folder you created on your computer.

To submit on Blackboard, follow these steps:

-   In the STAT 5700 Blackboard site, navigate to Lab 01 under Assignments
...
See cheatsheet on Blackboard for more extensive list. And remember: Google is your friend!
