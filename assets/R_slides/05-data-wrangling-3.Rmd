...
+ using computing (conditional) proportions using `dplyr` verbs
...
.question[
How could we investigate the gender distribution by department?
]
...
ucbadmit |> 
  ...
  summarize(prop_admitted = sum(admit == "Admitted")/n())
...
[TED-Ed: How statistics can be misleading](https://www.youtube.com/watch?v=sxYrzzy3cq8)
